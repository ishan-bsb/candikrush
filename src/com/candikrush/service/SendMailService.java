...
public class SendMailService {
    ...
    private String getMailer(String summary, String form_action, String candidateId) {
        String mailer = "<html><body><TABLE width='100%' border='2' cellspacing='0' cellpadding='0'><tr>" + "<td>" + summary + "</td></tr><tr><td><FORM action=" + form_action + " method='POST'>"
                + "<input type='textarea' name='remarks' value='Review Comments'>" + "</input><br/><INPUT type='radio' name='result' value='fail'>"
                + "Reject<input type='hidden' name='candidateId' value='" + candidateId + "'>" + "<INPUT type='radio' name='result' value='pass'>pass<br/>"
                + "<button type='submit' value='submit'>Submit</button></FORM>" + "</td></tr></TABLE></body></html>";
